...
namespace fv
{
    defineTypeNameAndDebug(actuatorLineSource, 1);
...
void Foam::fv::actuatorLineSource::rigidBodyMotion(const fvMesh& mesh)
{
    ...
    Info << "Last Rotation centre: " << rotCenter_ << endl;
    ...
    if(debug)
    {
        ...
        Info << "Previous Rotation centre: " << prevRotCenter_ << endl;
        Info << "Rotation centre translation: " << translation << endl;
